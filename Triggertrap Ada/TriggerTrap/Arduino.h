// Originally the Arduino header files, this has been modified for this project!
// TODO: Migrate entirely away from Arduino code.
...
extern const TC0_t* timer_to_tc0_PGM[];
extern const TC1_t* timer_to_tc1_PGM[];
